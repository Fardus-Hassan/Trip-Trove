...
//     const [cards, setCards] = useState(info.slice(0, 3)); // Initially show three cards
//     const [startIndex, setStartIndex] = useState(3);

//     console.log(cards);

//     const handleViewMore = () => {
//         const nextCards = info.slice(0, startIndex + 3); // Show additional three cards
//         setCards(nextCards);
//         setStartIndex(startIndex + 3);
//     };

//     const handleLessMore = () => {
//         const nextCards = info.slice(0, startIndex - 3); // Show fewer three cards
//         setCards(nextCards);
//         setStartIndex(startIndex - 3);
//     };

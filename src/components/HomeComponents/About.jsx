...
const About = () => {
    return (
        <div className="max-w-[1440px] w-[95%] mx-auto mt-10 sm:mb-[100px] flex lg:flex-row flex-col justify-between items-center gap-10">
            ...
            <div className="lg:max-w-[50%] lg:px-0 px-6">
                ...
                <h3 className="text-pmColor text-base sm:text-lg font-nunito font-bold relative inline-block">ABOUT US
                    ...
                    <span className="w-20 h-[2px] sm:h-[3px] bg-pmColor block absolute bottom-2 left-[120%]"></span>
                </h3>
                <h1 className="text-black text-opacity-80 text-[32px] sm:text-[40px] font-nunito font-bold">Welcome to Trip <span className="text-pmColor">Trove</span></h1>
                ...
                <button className="sm:px-7 px-5 sm:py-4 py-3 text-white font-heebo font-medium sm:font-semibold mt-2 rounded-3xl bg-pmColor">Read More</button>
            </div>
        </div>
    );
};

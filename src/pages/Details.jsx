                    ...
                    <div className="text-base font-heebo font-medium my-5">
                        ...
                        <div className="flex md:flex-row gap-8 flex-col-reverse justify-between my-7">
                            <div className="space-y-4">
                                ...
                                <span className="flex justify-start items-center gap-2 text-sm sm:text-[16px] font-heebo font-semibold"><FaArrowRight className="text-pmColor text-sm sm:text-lg" /><strong className=" text-pmColor">Price Per Person :</strong> 5000<TbCurrencyTaka className="text-lg -ml-[10px] mb-[2px]" /></span>
